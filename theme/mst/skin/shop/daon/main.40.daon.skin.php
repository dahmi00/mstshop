...
<?php
	...
	if(!$is_soldout && !$row['it_tel_inq'])  echo "<button type=\"button\" class=\"btn_cart\" data-it_id=\"{$row['it_id']}\"><span >장바구니</span><i class=\"fa fa-shopping-basket\" aria-hidden=\"true\"></i></button>\n";
