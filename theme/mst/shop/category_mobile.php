...
<div id="mobile_category" class="menu">
    <div class="menu_wr">
        ...
        <ul id="cate_tnb">
			...
			<li><a href="<?php echo get_pretty_url('news'); ?>"><i class="fa fa-home"></i> 공지사항</a></li>
			<li><a href="<?php echo get_pretty_url('qna'); ?>"><i class="fa fa-pencil" aria-hidden="true"></i> 질문과답변</a></li>
